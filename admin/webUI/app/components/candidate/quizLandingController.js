(function() {
  function quizLandingController(
    $scope,
    $state,
    $stateParams,
    $http,
      ...
      $http(req).then(
        ...
        function(response, code) {
          ...
          if (response.data) {
            ...
            mainVm.errorMessage =
              "Something went wrong, mail us on contact@dgraph.io";
          }
        }
      );
    }
    ...
    function validateInput() {
      ...
      var totalInput =
        qlVm.info.General.length +
        qlVm.info.Score.length +
        qlVm.info.Contact.length;

      return (
        checkedInput == totalInput &&
        qlVm.candidate.name != "" &&
        qlVm.candidate.country &&
        qlVm.candidate.country.name != ""
      );
    }
    ...
    function saveName() {
      ...
      quizLandingService.addName(requestData).then(
        function(data) {
  ...
  angular
    .module("GruiApp")
    .controller("quizLandingController", quizLandingDependency);
})();
