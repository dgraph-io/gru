...
angular.module("GruiApp").constant("APP_REQUIRES", {
  ...
  scripts: {
    ...
    inviteController: [
      "app/components/invite/inviteController.js?v=20161122-1"
    ],
    inviteService: ["app/components/invite/inviteService.js?v=20161223-1"],
    quizLandingController: [
      "app/components/candidate/quizLandingController.js?v=20161124-1"
    ],
    quizLandingService: [
      "app/components/candidate/quizLandingService.js?v=20161027-1"
    ],
    candidateController: [
      "app/components/candidate/candidateController.js?v=20161125-1"
    ],
    candidateService: ["app/components/candidate/candidateService.js"],
    profileController: [
      "app/components/profile/profileController.js?v=20161215-1"
    ],
    profileService: ["app/components/profile/profileService.js?v=20161215-1"],
