...
angular.module('GruiApp').constant('APP_REQUIRES', {
  ...
  scripts: {
    ...
    'questionController': ['app/components/question/questionController.js?v=20161215-1'],
    ...
    'profileController': ['app/components/profile/profileController.js?v=20161215-1'],
