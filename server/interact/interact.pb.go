...
type GruQuizClient interface {
	SendQuestion(ctx context.Context, in *Req, opts ...grpc.CallOption) (*Question, error)
...
func (c *gruQuizClient) SendQuestion(ctx context.Context, in *Req, opts ...grpc.CallOption) (*Question, error) {
	out := new(Question)
	err := grpc.Invoke(ctx, "/interact.GruQuiz/SendQuestion", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type GruQuizServer interface {
	SendQuestion(context.Context, *Req) (*Question, error)
...
func _GruQuiz_SendQuestion_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Req)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GruQuizServer).SendQuestion(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/interact.GruQuiz/SendQuestion",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GruQuizServer).SendQuestion(ctx, req.(*Req))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _GruQuiz_SendQuestion_Handler,
		},
		{
...
var fileDescriptor0 = []byte{
	...
	,
}
